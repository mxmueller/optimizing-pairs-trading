...
with st.sidebar:
    ...
    stop_loss = st.number_input('Stop Loss %', value=2.0, step=0.5, format="%.1f")
...
if single_backtest.validate_data():
    ...
    with tab4:
        ...
        with col1:
            ...
            top_winners = single_backtest.trades_pnl.nlargest(5, 'pnl_net')[
                ['symbol', 'entry_date', 'exit_date', 'pnl_net', 'exit_type']
            ]
    ...
    with tab6:
        ...
        if trade_filter == "Winning":
            ...
            filtered_trades = single_backtest.trades_pnl[single_backtest.trades_pnl['pnl_net'] <= 0]
        elif trade_filter == "Stop Loss":
            filtered_trades = single_backtest.trades_pnl[single_backtest.trades_pnl['exit_type'] == 'stop_loss']
        else:
        ...
        trades_to_display = filtered_trades[
            ['symbol', 'position_type', 'entry_date', 'exit_date', 'pnl_raw', 'total_cost', 'pnl_net', 'exit_type']
        ].head(10)
